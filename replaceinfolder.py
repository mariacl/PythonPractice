...
def printInputFolder():
   print (entryBoxInputFile.get())
...
PrintInputFolderButton = Button(main, text="Print Folder", width=15, command = printInputFolder)
PrintInputFolderButton.grid(pady=10, row=45, column=10, sticky=W)
